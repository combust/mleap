package ml.combust.bundle.v07.serializer.attr

import ml.combust.bundle.HasBundleRegistry
import ml.combust.bundle.v07.dsl.{Attribute, AttributeList}

/** Class to separate an [[ml.combust.bundle.v07.dsl.AttributeList]] into two
  * [[ml.combust.bundle.v07.dsl.AttributeList]] objects, one with small attributes and one with large.
  *
  * An [[ml.combust.bundle.v07.dsl.Attribute]] is large or small according to the [[ml.combust.bundle.v07.dsl.Value#isLarge]] and
  * [[ml.combust.bundle.v07.dsl.Value#isSmall]] methods, respectively. This class is only used when
  * the [[ml.combust.bundle.v07.serializer.SerializationFormat.Mixed]] mode of serialization is
