...
/** Domain specific language for generating Bundle.ML models.
  ...
  *
  * [[ml.bundle.dsl.Bundle]] - Stores the name, version,
  *   serialization format, list of attributes, and list of root
  *   nodes in the bundle graph.
  *
  * [[ml.bundle.dsl.Node]] - A node for transforming data in the
  ...
  *
  * [[ml.bundle.dsl.Model]] - A model operation that transforms data
  ...
  *   stored here.
  *
  * [[ml.bundle.dsl.Attribute]] - Attributes are used to store values for
  *   [[ml.bundle.dsl.Model]]s and [[ml.bundle.dsl.Bundle]]s. They contain
  *   a name, a [[ml.bundle.DataType.DataType]] and a [[ml.bundle.dsl.Value]].
  *
  * [[ml.bundle.dsl.Value]] - Values store concrete data for an [[ml.bundle.dsl.Attribute]].
  ...
  *   data type.
  *
  * [[ml.bundle.dsl.AttributeList]] - Stores a set of [[ml.bundle.dsl.Attribute]]s.
  *
  * [[ml.bundle.dsl.Shape]] - Stores the map of graph input/output fields to
