...
/** Class that holds a map of string to [[ml.combust.bundle.v07.dsl.Value]] objects.
  *
  * Can only have one attribute with a given name at a time.
  *
  * @param lookup map of attribute name to [[ml.combust.bundle.v07.dsl.Value]] object
  */
