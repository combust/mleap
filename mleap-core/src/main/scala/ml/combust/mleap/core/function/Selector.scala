...
/** Trait for a LeapFrame selector.
  ...
  * in a [[ml.combust.mleap.core.frame.Row]]. The name parameters
...
/** Class for a selector that extracts the value of a field from a [[ml.combust.mleap.core.frame.Row]].
  *
  * @param field name of field to extract
  */
case class FieldSelector(field: String) extends Selector

/** Class for a selector that constructs an array from values in a [[ml.combust.mleap.core.frame.Row]].
  *
