...
class OneVsRestOp extends SimpleSparkOp[OneVsRestModel] {
  ...
  override def sparkInputs(obj: OneVsRestModel): Seq[ParamSpec] = Seq("features" -> obj.featuresCol)

  override def sparkOutputs(obj: OneVsRestModel): Seq[SimpleParamSpec] = Seq("prediction" -> obj.predictionCol)
