...
object Dependencies {
  ...
  val sparkVersion = "4.1.2" // Upgraded for Spark 4.1 with Scala 2.13 and Java 17 support
  ...
  object Compile {
    ...
    var tensorflowCoreNative = "org.tensorflow" % "tensorflow-core-native" % tensorflowJavaVersion
    tensorflowPlatforms.foreach(platform => tensorflowCoreNative = tensorflowCoreNative classifier platform)
    val tensorflowDeps = Seq(tensorflowCoreApi, tensorflowCoreNative)
